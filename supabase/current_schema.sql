...
--
-- Name: pg_rest_root(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE OR REPLACE FUNCTION "public"."pg_rest_root"() RETURNS "json"
...
ALTER FUNCTION "public"."pg_rest_root"() OWNER TO "postgres";

--
-- Name: FUNCTION "pg_rest_root"(); Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON FUNCTION "public"."pg_rest_root"() IS 'Hide the OpenAPI schema for the /rest/v1/ endpoint.';
...
--
-- Name: FUNCTION "pg_rest_root"(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION "public"."pg_rest_root"() TO "anon";
GRANT ALL ON FUNCTION "public"."pg_rest_root"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."pg_rest_root"() TO "service_role";
